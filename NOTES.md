...
writing the README. With strictly past-lag features the model never interpolates, it only ever sees earlier values, whichever rows are held out. What it gets in
